...
public static class InputManager
{
	...
	public static void Init()
	{
		...
		{
			LuaEngine.Logger.LogWarning("Could not find any Input module!");
	...
	public static Vector3 MousePosition => m_inputModule?.MousePosition ?? new();

	public static bool GetKeyDown(KeyCode key) => m_inputModule?.GetKeyDown(key) ?? false;
	public static bool GetKey(KeyCode key) => m_inputModule?.GetKey(key) ?? false;

	public static bool GetMouseButtonDown(int btn) => m_inputModule?.GetMouseButtonDown(btn) ?? false;
	public static bool GetMouseButton(int btn) => m_inputModule?.GetMouseButton(btn) ?? false;
