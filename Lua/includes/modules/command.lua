...
-----------------------------------------------------------]]
function command.GetTable() return commandlist, completelist end

--[[---------------------------------------------------------
   Name: command.Add( name, func, completefunc, help)
   Desc: Register a new console command
-----------------------------------------------------------]]
function command.Add(name, func, completefunc, help)
...
-----------------------------------------------------------]]
function command.Run(command, arguments, argstring)
...
-----------------------------------------------------------]]
function command.AutoComplete(command, arguments)
    local lowercommand = string.lower(command)
